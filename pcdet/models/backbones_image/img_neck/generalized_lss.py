...
class GeneralizedLSSFPN(nn.Module):
    ...
    def __init__(self, model_cfg):
        ...
        in_channels =  self.model_cfg.IN_CHANNELS # [192, 384, 768]
        out_channels = self.model_cfg.OUT_CHANNELS # 256
        num_ins = len(in_channels)
        num_outs = self.model_cfg.NUM_OUTS # 3
        start_level = self.model_cfg.START_LEVEL # 0
        end_level = self.model_cfg.END_LEVEL # -1
