...
class Detector3DTemplate(nn.Module):
    ...
    def build_networks(self):
        ...
        for module_name in self.module_topology:  # ['vfe', 'map_to_bev_module', 'backbone_2d', 'dense_head']
    ...
    def build_vfe(self, model_info_dict):
        ...
        # model_info_dict： 'modual_list' 'num_rawpoint_features': 7, 'num_point_features': 64, 'grid_size': array([1000,  500,    1]), 'point_cloud_range': array([-50. , -25. ,...e=float32), 'voxel_size': [0.1, 0.1, 4.0]}
    ...
    def build_map_to_bev_module(self, model_info_dict):
        # 创建MAP_TO_BEV：PointPillarScatter
